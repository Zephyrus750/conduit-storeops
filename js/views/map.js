...
export function selCard(ctx, map, id) {
  ...
  return `<div class="card selshelf" id="selshelf"><div class="ch"><h3>Selected shelf</h3><span class="go" data-act="clear">Clear</span></div>` +
    ...
    `<div class="acts2"><a class="btn primary sm" data-go="picklist" data-select="${esc(id)}">${ic('m-picklist')}Pick list</a><a class="btn sm" data-go="refresh" data-select="${esc(id)}">${ic('m-refresh')}Refresh</a><a class="btn sm" data-go="labelint" data-select="${esc(id)}">${ic('m-labelint')}Label check</a></div></div>`;
}
